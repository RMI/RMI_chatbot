...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        ...
        The columns of the 'country_emissions_by_sector' dask dataframe are: 'iso3_country', 'original_inventory_sector', 'start_time', 'end_time', 'gas', 'emissions_quantity', 'emissions_quantity_units', 'temporal_granularity', 'created_date', 'modified_date.
