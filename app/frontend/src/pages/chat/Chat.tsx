                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Plot Generator</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Get answers to questions about Climate TRACE documents</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question (e.g. explain emissions from shipping)"
                            disabled={isLoading}
